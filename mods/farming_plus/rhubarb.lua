...
minetest.register_node("farming_plus:rhubarb", {
	...
	drop = {
		...
		items = {
			...
			{ items = {'farming_plus:rhubarb_seed'}, rarity = 4},
...
minetest.register_craftitem("farming_plus:rhubarb_item", {
	description = "Rhubarb (+2)",
	inventory_image = "farming_rhubarb.png",
})

farming:add_plant("farming_plus:rhubarb", {"farming_plus:rhubarb_1", "farming_plus:rhubarb_2"}, 50, 15)
